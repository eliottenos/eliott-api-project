...
/***/ (function(module, exports, __webpack_require__) {
	...
	var locationEvents = __webpack_require__(7);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://afternoon-retreat-52136.herokuapp.com/',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateLocation = function onCreateLocation(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.createLocation(data).then(ui.createLocationSuccess).catch(ui.createLocationFailure);
	};
	...
	var onGetLocation = function onGetLocation(event) {
	  ...
	  // debugger
	  event.preventDefault();
	  var location = getFormFields(event.target).location;
	  // debugger
	  console.log('location', location);
	  if (location.id.length !== 0) {
	    api.getLocation(location).then(ui.getLocationSuccess).catch(ui.getLocationError);
	    // } else {
	    //   console.log('Please provide a location id!')
	  }
	};

	var onUpdateLocation = function onUpdateLocation(event) {
	  event.preventDefault();
	  // console.log('inside of onUpdateLocation')
	  var data = getFormFields(event.target);
	  api.updateLocation(data).then(ui.updateLocationSuccess).catch(ui.updateLocationFailure);
	  // }
	};
	...
	var onDeleteLocation = function onDeleteLocation(event) {
	  ...
	  console.log('location', location);
	  if (location.id.length !== 0) {
	    api.deleteLocation(location).then(ui.updateLocationSuccess).catch(ui.updateLocationFailure);
	    // } else {
	    //   console.log('Please provide a location id!')
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var deleteLocation = function deleteLocation(data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createLocationSuccess = function createLocationSuccess(data) {
	  console.log(data);
	  $('.createSuccess').empty();
	  $('.createBlank').empty();
	  $('.createBlank1').empty();
	...
	var createLocationFailure = function createLocationFailure(error) {
	...
	var getLocationFailure = function getLocationFailure(error) {
	...
	var updateLocationSuccess = function updateLocationSuccess(data) {
	  console.log(data);
	  $('.auth').text('You updated a location!');
	};

	var updateLocationFailure = function updateLocationFailure(error) {
	  console.log('error on update location in ', error);
	};

	var deleteLocationSuccess = function deleteLocationSuccess(data) {
	  console.log('success delete location');
	  $('.auth').text('You deleted a location!');
	  $('.form-reset').trigger('reset');
	};

	var deleteLocationFailure = function deleteLocationFailure(error) {
	  console.log('error on delete location in ', error);
	};

	var weatherSuccess = function weatherSuccess(data) {
	  console.log(data);
	  $('.weatherDiv').append($(data).data.id);
	};

	var weatherFailure = function weatherFailure(error) {
	  console.log(error);
	...
	module.exports = {
	  ...
	  createLocationFailure: createLocationFailure,
	  getLocationSuccess: getLocationSuccess,
	  getLocationFailure: getLocationFailure,
	  updateLocationSuccess: updateLocationSuccess,
	  updateLocationFailure: updateLocationFailure,
	  deleteLocationSuccess: deleteLocationSuccess,
	  deleteLocationFailure: deleteLocationFailure,
